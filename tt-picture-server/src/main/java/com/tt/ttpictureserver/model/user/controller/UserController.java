...
public class UserController {
    ...
    @PostMapping("/login")
    @ApiOperation("用户登录")
    public BaseResponse<LoginUserVo> Register(@RequestBody UserLoginRequest UserLoginRequest,
    ...
    public BaseResponse<Page<UserVo>> getUserList(@RequestBody UserQueryRequest userQueryRequest) {
        ...
        Page<User> userPage = userService.page(new Page<>(current, pageSize),
                userService.getQueryRequest(userQueryRequest));
        ...
        System.out.println("userPage.getRecords() size: "
                + (userPage.getRecords() != null ? userPage.getRecords().size() : "null"));
